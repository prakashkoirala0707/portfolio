...
SECRET_KEY = 'django-insecure-x6v5*k$!xm36u!i2*!y^s++%p*%!p3q$90ag4j5px+0on7&dsq'
...
STATIC_URL = '/static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'assets')  # The directory where collected static files will be stored during production
# settings.py
